...
## 📝 소개
AI 이미지 분석 기술을 이용한 차량 파손 금액 측정 서비스 프로젝트에서 backend 및 DB 설계를 담당하였습니다.<br>
<br>
Carkey 서비스는 사용자가 스크래치된 차량 사진을 찍어서 업로드시 스크래치된 영역의 픽셀량을 추출하여 예상 수리비를 측정해주는 기능을 제공합니다.
<br>
